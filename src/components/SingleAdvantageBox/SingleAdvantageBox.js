...
const advantagesResources = {
    central_arena: {
        ...
        alt: 'הזירה המרכזית',
        title: 'הזירה המרכזית',
        text: 'AcadeME היא פלטפורמה ייחודית וחדשנית המייצרת אינסוף הזדמנויות ונותנת מענה שלם וחכם לסטודנטים ובוגרים, מעסיקים וחברות  ולמרכזי פיתוח קריירה במוסדות האקדמיים בישראל.'
    },
    grounded: {
        src: flagIcon,
        alt: 'חיים את השטח',
        title: 'חיים את השטח',
        text: 'AcadeME מותקנת ועובדת בשיתוף פעולה מלא ומוצלח מערכת עם רוב המוסדות האקדמיים המובילים בישראל ובעלת מאגר הסטודנטים והבוגרים הגדול ביותר בישראל.'
    },
    market_and_share: {
        src: rocketIcon,
        alt: 'מקדמים ומשתפים',
        title: 'מקדמים ומשתפים',
        text: 'AcadeME  מאפשרת למעסיקים לקדם, לשתף ולפרסם את משרותיהם בין המוסדות האקדמיים - בלחיצת כפתור. למתג ולפרט על החברה ופועלה, לצרף לוגו, וידאו, תמונות, פרזנטציית חברה ועוד. מצד שני היא מאפשרת למועמדים ליצור לעצמם פרופיל מפורט ועשיר במערכת הכולל את האפשרות להעלות ולצרף מסמכים, גליונות ציונים, וידאו, תמונות, תיק עבודות, קישורים לרשתות חברתיות, קורות חיים ועוד.'
    },
    expenses_and_time: {
        src: eyeIcon,
        alt: 'חוסכים זמן וכסף',
